...
class TestCostPartitioning:
    def test_reserves_budget_sequentially_within_group(self):
        ...
        runnable, skipped = partition_signals_by_cost(group, total_cost=30, max_cost=100, budget_override=False)
    ...
    def test_override_cost_flag_runs_all(self):
        ...
        runnable, skipped = partition_signals_by_cost(group, total_cost=0, max_cost=50, budget_override=True)
    ...
    def test_prior_order_cost_reduces_remaining_budget(self):
        ...
        runnable, skipped = partition_signals_by_cost(
            group, total_cost=50, max_cost=100, budget_override=False
        )
        assert runnable == []
