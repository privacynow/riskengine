...
Expose port `8000` through your reverse proxy or security group. Do **not** publish the admin UI or APIs to the public internet without production identity, TLS, secret management, and the hardening described in [ARCHITECTURE.md](ARCHITECTURE.md).
